...
def dist_py(points):
    """try to replace the raw knn based on CUDA for OOM 
    """
...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int):
        ...
        # https://winka9587.github.io/posts/SH_color/
        self._features_dc = torch.empty(0) # diffuse color, the essential color of object without considering of light factorc
        self._features_rest = torch.empty(0) # remained coefficients of sh
